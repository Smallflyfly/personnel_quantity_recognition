...
def save_checkpoint(config, epoch, model, max_accuracy, optimizer, lr_scheduler, loss_scaler, logger, fold=None):
    ...
    save_path = os.path.join(config.OUTPUT, f'ckpt_epoch_{epoch}.pth' if fold is None else f'ckpt_epoch_{epoch}_{fold}.pth')
